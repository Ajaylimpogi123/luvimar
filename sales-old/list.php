...
if (!defined('WEB_ROOT')) {
	...
	if(isset($_GET['pid']))
	{ $pid = $_GET['pid']; include "insert_order.php"; }else{}
			...
			<td>
				<?php
					...
					if($crt->rowCount() > 0)
					{
						...
						if($crt->rowCount() > 1){ $pl = "s"; }else{ $pl = ""; }
				?>
						...
						<a href="index.php?view=cart" class="a-btn">
							<span class="a-btn-text">Go to Cart<br /><small style="font-size:13px;"><?php echo $totalqty; ?> item<?php echo $pl; ?></small></span> 
