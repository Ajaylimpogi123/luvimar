...
<div class="row-fluid sortable">
	<div class="box span8">
		<div class="box-header well" data-original-title>
			<h2><i class="icon-edit"></i> Modify Raw Material</h2>
		</div>
			...
			<div class="box-content">
				...
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-xlarge focused" name="unit"  autocomplete=off style="width:100px;" placeholder="Unit" required value="<?php echo $sql_data['pd_unit']; ?>" />
