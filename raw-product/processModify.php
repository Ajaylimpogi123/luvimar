...
/* Update Product */
$sql = $conn->prepare("UPDATE tbl_product SET  pd_name = '$name', pd_description = '$description', pd_cost = '$cost', 
								...
								pd_unit = '$unit', pd_image = $mainImage, pd_thumbnail = $thumbnail,  date_modified = NOW() 
										WHERE pd_id = '$id'");
$sql->execute();
/* End Product */
