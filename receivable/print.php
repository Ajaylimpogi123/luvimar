		...
		<tr>
			<td>
				...
				<div class="reciept-container" style="text-align: center;">
					<h5 class="reciept">===========================</h5>
					<h5 class="reciept">Store: LUVIMAR FIRE CONTROL AVENUE</h5>
					<h5 class="reciept">Address: Terra Plaza, Cor. </h5>
					<h5 class="reciept">Rizal - Gatualas Sts., Bacolod City</h5>
					<h5 class="reciept">Tel. Nos: 476-2612 / 708-6185 / 213-2714</h5>
					<h5 class="reciept">Mobile Nos: 0949-3934805 / 0912-5374747</h5>
					<h5 class="reciept">===========================</h5>
				</div>
				...
				<table class="table" width="200">
					<tr>
						<td><span <?php echo $dsgn1; ?>>Ref No.</span></td>
						<td align="right"><span <?php echo $dsgn1; ?>><?php echo $sql_data7['ref_number']; ?></span></td>
					</tr>
					<tr>
