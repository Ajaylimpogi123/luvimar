...
/* Insert Product */
$sql = $conn->prepare("INSERT INTO tbl_product (cat_id, cat_parent_id, pd_barcode, pd_name, pd_name7, pd_description, pd_keyword, pd_cost, pc_formula, ib_formula, bx_formula, pc_price, ib_price, bx_price, pc_qty, ib_qty, bx_qty, pd_mqty, pd_unit, pd_expiration, pd_image, pd_thumbnail, date_added, is_deleted)
VALUES ('$category', '$catpid', '$barcode', '$name', '$pdname', '$description', '$keyword', '$cost', '$pc_frm', '$ib_frm', '$bx_frm', '$pc_prc', '$ib_prc', '$bx_prc', '$pc_qty', '$ib_qty', '$bx_qty', '$mqty', '$unit', '$expiration', '$mainImage', '$thumbnail', '$today_date1', '0')");
$sql->execute();
/* End Product */
