		...
		<div class="row-fluid sortable">		
				<div class="box span4">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-inbox"></i> Return Product</h2>						
						<div class="box-icon">																					
							...
							<tr>											
								<td>
									<select id="selectError" name="pid" id="pid" data-rel="chosen">
										<?php
											$prd = $conn->prepare("SELECT * FROM tbl_product WHERE is_deleted != '1'");
											$prd->execute();
											if($prd->rowCount() > 0)
											{
												...
												{
										?>
													<option value="<?php echo $prd_data['pd_id']; ?>"><?php echo $prd_data['pd_name']; ?></option>
										<?php
												} // End While
											}else{}
										?>
