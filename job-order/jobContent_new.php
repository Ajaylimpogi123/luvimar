<div class="box span7">
    ...
    <div class="box-content">
        <?php
        $sql1 = $conn->prepare("SELECT * FROM tbl_jo_items_new WHERE is_deleted != '1' AND is_submitted != 1 ORDER BY join_id DESC");
        $sql1->execute();
            ...
            <table border="0" width="100%">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td width="10px;">&nbsp;</td>
                        <td><a class="btn btn-danger" href="processDelete_new.php?uid=<?php echo $sql1_data['uid']; ?>"> <i class="icon-trash icon-white"></i>Delete</a></td>
                        <td width="10px;">&nbsp;</td>
        ...
        <form action="processAddJobOrder_new.php" method="post">
            <?php

            $chk = $conn->prepare("SELECT * FROM tbl_jo_items_new WHERE is_deleted != '1'");
            $chk->execute();
            $rows = $chk->fetchAll();
