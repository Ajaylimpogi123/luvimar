			...
			<div class="box-content">
				...
				<fieldset>
					...
					<div class="control-group">
						...
						<div class="controls">
							<select id="selectError4" name="pdId" id="pid" data-rel="chosen" required>
								...
								<?php
								$prd = $conn->prepare("SELECT * FROM tbl_product WHERE is_deleted != '1' AND pd_id NOT IN (SELECT pd_id FROM tbl_jo_items WHERE is_deleted != '1' AND is_submitted != 1)");
								$prd->execute();
								if ($prd->rowCount() > 0) {
					...
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-xlarge focused" value="1" id="barcode" name="qty" type="text" />
							<div id="status"></div>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<div style=" padding-top: 10px">
								...
								<label>
									<input type="radio" name="job_description" required checked
										value="refill"> Refill
								</label>
							</div>
						</div>
