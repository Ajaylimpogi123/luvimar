				...
				<div class="box span8">
					...
					<div class="box-content">
							...
							<div class="form-actions">
								<input type="hidden" name="id" value="<?php echo $sql_data['id']; ?>" />
				...
				<div class="box span4">
					...
					<div class="box-content">
						...
						?>
								...
								<br /><br />
									<a class="btn btn-danger" href="javascript:delimg(<?php echo $sql_data['id']; ?>);"><i class="icon-trash icon-white"></i> Delete Image</a>
						<?php
							} else {
