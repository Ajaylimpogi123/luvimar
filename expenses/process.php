...
function add_category()
{
    ...
    $details = $_POST['details'];
		...
		$sql   = $conn->prepare("INSERT INTO tr_expense_category (expense_category_name, details, date_added, is_deleted) 
...
function add()
{
    ...
    $details = $_POST['details'];
		...
		$sql   = $conn->prepare("INSERT INTO tr_expense (ec_id, amount, details, date_added, is_deleted) 
				  VALUES ('$exp_cat', '$amount', '$details', '$today_date2', '0')");
		$sql->execute();
...
function modify()
{
    ...
    $details = $_POST['details'];
		...
		$sql    = $conn->prepare("UPDATE tr_expense
						SET amount = '$amount', details = '$details', date_modified = '$today_date1'
							WHERE exp_id = $exid");
