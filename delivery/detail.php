					...
					?>
							...
							<tr>								
								...
								<td width="100px;"><b>Sub-Total</b></td>
									...
									?>				
											  <tr>												
												<td><span class="border_cart"></span><?php echo $sql_data['pd_name']; ?></td>
												<td width="10px;">&nbsp;</td>
												<td><span class="border_cart"></span>Php <?php echo number_format($sql_data['od_price'], 2); ?></td>
												<td width="10px;">&nbsp;</td>
												<td align="center"><?php echo $sql_data['od_qty']; ?> <?php echo $sql_data['pd_type']; ?></td>
												<td width="10px;">&nbsp;</td>
				...
				<div class="box-content">
					<table class="table table-striped table-bordered">
						...
						<tr> 
							...
							<td><span class="blue" style="font-size:14px; font-weight:bold;">&#x20B1; <?php echo number_format($sql_data['od_discount'], 2); ?></span></td>
						</tr>
						<tr> 
							<td width="150"><span class="red" style="font-size:14px; font-weight:bold;">% Discount</span></td>
					...
					<table class="table table-striped table-bordered">						
						<tr> 
							<td width="150"><span class="black" style="font-size:11px; font-weight:bold;">Delivery Date</span></td>
							<td><span class="black" style="font-size:11px; font-weight:bold;"><?php echo $deldate; ?></span></td>
						</tr>
						<tr> 
							<td width="150"><span class="blue" style="font-size:14px; font-weight:bold;">Delivery Address</span></td>
							<td><span class="blue" style="font-size:14px; font-weight:bold;"><?php echo $sql_data['delivery_address']; ?></span></td>
						</tr>
						<tr> 
							<td width="150"><span class="blue" style="font-size:14px; font-weight:bold;">Driver</span></td>
							<td><span class="blue" style="font-size:14px; font-weight:bold;"><?php echo $sql_data['driver']; ?></span></td>
						</tr>
						<tr>							
							<td colspan="2">
								...
								&nbsp;
								<a class="btn btn-primary" href="print.php?oid=<?php echo $od_id; ?>" target=_blank>
