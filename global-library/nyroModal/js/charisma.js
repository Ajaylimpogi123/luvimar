$(document).ready(function () {
  ...
  var current_theme =
    $.cookie("current_theme") == null ? "cerulean" : $.cookie("current_theme");
...
function docReady() {
  ...
  // datepicker end date not less than start date
  $(document).ready(function () {
  ...
  $("ul.gallery li").hover(
    function () {
      ...
      $(this)
        ...
        .stop()
        .animate({ "margin-top": "-1" }, 400, "easeInQuint");
    },
    function () {
      $("img", this).fadeToggle(1000);
      $(this)
        .find(".gallery-controls")
        .stop()
        .animate({ "margin-top": "-30" }, 200, "easeInQuint", function () {
          $(this).remove();
        });
    },
  );
  ...
  if ($(".tour").length && typeof tour == "undefined") {
    ...
    tour.addStep({
      element:
        ".span10:first" /* html element next to which the step popover should be shown */,
      placement: "top",
      title: "Custom Tour" /* title of the popover */,
      content:
        "You can create tour like this. Click Next." /* content of the popover */,
    });
    tour.addStep({
