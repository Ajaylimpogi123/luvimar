...
checkUser();
	...
	if($branch != 0)
	{		
		$cust_state = "AND oi.branch_id = '$branch' AND oi.is_accepted = '1'";
...
?>		
<head>		
<title>Transfer Product Report</title>
...
{   
   ...
   font-size:13px;
		...
		<tr>
			<td><img src="<?php echo WEB_ROOT; ?>images/logo.png" style="height: 80px; width:300px;" /></td>
			<td>&nbsp; &nbsp;</td>
			<td>
				<h3>Transfer Product Report</h3>
				...
				<td colspan="13"><hr color='black' /></td>
								  ...
								  <tbody>
									<?php
										...
										if($emp->rowCount() > 0)
										{
											$ctr1 = 1; $total_qty = 0; $total_bal = 0;
									...
									<tr>
										...
										<td></td>
										<td class="tddata"><b><?php echo number_format($total_bal, 0); ?></b></td>
									</tr>
									<tr><td><br /></td></tr>
