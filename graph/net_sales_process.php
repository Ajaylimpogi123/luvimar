...
checkUser();
	...
	$last_date = date('Y-m-d', strtotime('-3 days'));
	...
	$del = $conn->prepare("DELETE FROM tr_graph_net_current");
	$del->execute();
?>		
<!--<table>!-->
<?php
	for ($currentDateTS = $fromDateTS; $currentDateTS <= $toDateTS; $currentDateTS += (60 * 60 * 24)) 
	{
		...
		$in = $conn->prepare("INSERT INTO tr_graph_net_current (branch_id, date_name, total_sales, od_date) VALUES ('$userId', '$dtname', '$total_sales', '$dd')");
		$in->execute();
?>
	<!--<tr>
