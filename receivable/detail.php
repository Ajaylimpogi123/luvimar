		...
		<form action="process.php?action=saveorder" method="post" name="frmCart" id="frmCart">
			<div class="box span6">
				<div class="box-header well" data-original-title>
					<h2><i class="icon-file"></i> Order Details - Ref #: <span style="color: #000000;"><?php echo $sql2_data['ref_num']; ?></span> 
				</h2>
				-
					<span style="
						...
						font-weight:600;
						color:#fff;
						background: <?= $sql2_data['is_paid'] > 0 ? '#28a745' : '#dc3545' ?>;
					"><?php echo ucfirst($sql2_data['is_paid'] > 0 ? 'Paid' : 'Unpaid') ?></span>
				</div>
								...
								<td width="100px;"><b>Sub-Total</b></td>
									...
									?>				
											  <tr>												
												...
												<td width="10px;">&nbsp;</td>
												<td><span class="border_cart"></span>&#x20B1; <?php echo number_format($sql_data['od_price'], 2); ?></td>
												<td width="10px;">&nbsp;</td>
												<td align="center"><?php echo $sql_data['od_qty']; ?></td>
												<td width="10px;">&nbsp;</td>
												<td><span class="border_cart"></span>&#x20B1; <?php echo number_format($subTotal, 2); ?></td>												
											  </tr>
									<?php
											} // End For
			...
			<div class="box span6">
				...
				<div class="box-content">
					<table class="table table-striped table-bordered">
						...
						<tr>							
							<td colspan="2"><a href="print.php?oid=<?php echo $orderId; ?>" class="btn btn-small" target=_new>Print</a> | <input name="btnBack" type="button" id="btnBack" value="Go Back" onClick="window.location.href='index.php?view=list'" class="btn btn-small">
								<?php if($user_data['is_receivable_paid_access'] == 1){ ?>
							|
								
							 <a href="process.php?action=paid&oid=<?php echo $orderId; ?>" class="btn btn-small btn-primary" >Mark As Paid</a>
