...
/* Insert Product */
$sql = $conn->prepare("INSERT INTO tbl_jo_items_new
    (branch_id, cust_id, pd_id, customer_name, pd_name, qty, pd_price, pd_serial, description, job_description, date_needed, remarks, join_date_added, added_by, is_deleted)
...
$up = $conn->prepare("UPDATE tbl_jo_items_new SET uid = '$uid' WHERE join_id = '$id'");
$up->execute();
...
header('Location: index.php?view=add_new&error=' . urlencode('Added successfully'));
